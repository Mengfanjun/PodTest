...
//  Copyright © 2016年 新能源金服（杭州）有限公司. All rights reserved.
//
...
+ (void)toast:(NSString *)message {
    ...
    [MBProgressHUD hideHUDForView:keyView animated:YES];
    [self toastMsg:message image:[UIImage imageNamed:@"white_warning"] inWindow:keyView];
}
